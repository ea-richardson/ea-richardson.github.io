...
accordions.forEach((accordion) => {
    accordion.addEventListener("click", function () {
        // Get the associated panel (the content to be expanded/collapsed)
        const panel = this.nextElementSibling;

        // First, remove the "active" class from all accordion buttons
        accordions.forEach((acc) => {
            acc.classList.remove("active");
        });

        // Then toggle the "active" class on the clicked accordion
        ...
        if (panel.style.maxHeight) {
            ...
            // Open the clicked panel by setting maxHeight to the scrollHeight
